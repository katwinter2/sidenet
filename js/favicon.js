...
(function() {
  ...
  const PRIDE_COLORS = CONFIG.favicon.colors;
  ...
  function renderFavicon() {
    ...
    phase = (phase + CONFIG.favicon.phaseIncrement) % 1;
  }

  function startFaviconCycle() {
    if (!faviconInterval) {
      faviconInterval = setInterval(renderFavicon, CONFIG.favicon.animationInterval);
      renderFavicon();
    }
  }
